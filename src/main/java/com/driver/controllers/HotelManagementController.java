...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel){
        ...
        String added=hotelManagementService.addHotel(hotel);
        return added;
    }
    ...
    public Integer addUser(@RequestBody User user){
        ...
        Integer aadharNum=hotelManagementService.addUser(user);
       return aadharNum;
    }
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        int amount=hotelManagementService.bookARoom(booking);
        return amount;
    }
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        int bookingsDone=hotelManagementService.getBookings(aadharCard);
        return bookingsDone;
    }
    ...
    /*public static class HotelManagementService {
